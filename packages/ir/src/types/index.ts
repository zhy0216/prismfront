// packages/ir/src/types —— IR 权威类型（irVersion 见 ir-version.ts 的 IR_VERSION，
// = 2.1.0 基线 + 决策 #9 的 cond.has_color + M5/T5 的 act.strike.amount）。
//
...
//   1. irVersion 基线定为 "2.1.0"             → ir-version.ts（此后两次 minor bump 的理由写在那）
